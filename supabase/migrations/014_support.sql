...
INSERT INTO support_faq (question, answer, category, sort_order) VALUES
  ('كيف أقدّم طلباً للخدمة؟',
   'اضغط على زر "طلب جديد" في الشاشة الرئيسية، اختر التصنيف المناسب، أضف وصفاً للعمل وحدد موقعك. ستصلك عروض من المقدمين خلال دقائق.',
   'order', 1),
  ('كيف أختار أفضل عرض؟',
   'قارن بين العروض من حيث السعر والتقييم وعدد الأعمال المنجزة. يمكنك أيضاً مراجعة معرض الأعمال لكل مقدم قبل الاختيار.',
   'order', 2),
  ...
  ('هل الدفع آمن؟',
   ...
   'payment', 4),
  ('كيف أصبح مقدماً؟',
   'سجّل حساباً كمقدم خدمات، أكمل ملفك الشخصي وأضف تخصصاتك ومدينتك. بعد مراجعة الفريق ستتمكن من تلقي الطلبات.',
   'account', 5),
