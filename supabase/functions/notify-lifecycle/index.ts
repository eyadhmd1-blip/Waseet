...
function clientOnboardingCopy(lang: string) {
  return lang === "en"
    ...
    : {
        ...
        body: "صف ما تحتاجه واحصل على عروض من مقدمين موثوقين.",
      };
}
...
function portfolioReminderCopy(lang: string) {
  return lang === "en"
    ...
    : {
        ...
        body: "المقدمون الذين لديهم بورتفوليو يفوزون بعروض أكثر بـ 3 أضعاف. أضفها الآن!",
      };
}
...
function reengagementCopy(lang: string, role: string) {
  ...
  return role === "provider"
    ? {
        ...
        body: "العملاء يبحثون عن مقدمين مثلك. لا تفوّت الفرصة.",
      }
    : {
