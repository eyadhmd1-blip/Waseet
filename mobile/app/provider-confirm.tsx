...
const styles = StyleSheet.create({
  ...
  jobTitle:         { fontSize: 15, fontWeight: '700', color: COLORS.textPrimary, textAlign: 'right', marginBottom: 4 },
  jobCity:          { fontSize: 12, color: COLORS.textMuted, textAlign: 'right', marginBottom: 2 },
  jobClient:        { fontSize: 12, color: COLORS.textMuted, textAlign: 'right' },
