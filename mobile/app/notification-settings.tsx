...
function createSt(colors: AppColors, isRTL: boolean, isDark: boolean) {
  ...
  quietChips:          { flexDirection: 'row', flexWrap: 'wrap', gap: 6, justifyContent: 'center' },
  quietChip:           { width: '47%', backgroundColor: colors.bg, borderRadius: 10, paddingVertical: 8, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
