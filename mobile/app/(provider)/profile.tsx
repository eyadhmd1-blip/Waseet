...
const styles = StyleSheet.create({
  ...
  discountBanner:{ backgroundColor: COLORS.accentDim, borderRadius: 10, padding: 10, marginTop: 12, borderWidth: 1, borderColor: '#78350F' },
  discountText:  { fontSize: 13, color: COLORS.accent, textAlign: 'center' },
  creditsBadge:     { backgroundColor: 'rgba(245,158,11,0.1)', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 7, marginTop: 10, borderWidth: 1, borderColor: 'rgba(245,158,11,0.25)' },
