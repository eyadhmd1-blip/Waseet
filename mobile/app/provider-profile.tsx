...
const styles = StyleSheet.create({
  ...
  recommendedPill: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3, backgroundColor: '#78350F' },
  ...
  videoThumbBg:  { alignItems: 'center', justifyContent: 'center', backgroundColor: '#1E293B' },
  ...
  referralCard:    { backgroundColor: '#1C1A0E', borderRadius: 16, padding: 18, borderWidth: 1, borderColor: '#78350F', alignItems: 'center', gap: 8 },
  referralTitle:   { fontSize: 17, fontWeight: '800', color: COLORS.accent, textAlign: 'center' },
  referralSub:     { fontSize: 13, color: '#92400E', textAlign: 'center', lineHeight: 20 },
