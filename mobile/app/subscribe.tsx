...
const PLAN_FEATURE_KEYS: Record<string, { key: string; included: boolean }[]> = {
  trial: [
    { key: 'featureCredits_trial',  included: true  },
    ...
    { key: 'featureFullAnalytics',  included: false },
  ],
  basic: [
    { key: 'featureCredits_basic',  included: true  },
    { key: 'featureProfile',        included: true  },
    { key: 'featureReplies',        included: true  },
    { key: 'featurePriorityRank',   included: false },
    { key: 'featureVerifiedBadge',  included: false },
  ...
  pro: [
    { key: 'featureCredits_pro',    included: true  },
    { key: 'featureProfile',        included: true  },
  ...
  premium: [
    { key: 'featureCredits_premium', included: true },
    { key: 'featureMaxBids',         included: true },
