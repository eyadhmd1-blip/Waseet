...
// ─── Icon key → Emoji map (single source of truth) ──────────
export const ICON_MAP: Record<string, string> = {
  ...
  wind:           '❄️',  // تكييف وتبريد
  hammer:         '🔨',  // نجارة
  paintbrush:     '🎨',  // دهان وديكور
  wrench:         '🔧',  // إصلاح أجهزة منزلية
  tile:           '🪵',  // بليط وأرضيات
  plaster:        '🪣',  // قصارة وتشطيب
  iron:           '⚒️',  // حدادة ولحام
  aluminium:      '🪟',  // ألمنيوم
  sofa:           '🛋️',  // تنجيد وإصلاح أثاث
  ...
  wifi:           '📡',  // شبكات وإنترنت
  cctv:           '📹',  // كاميرات مراقبة
  'solar-panel':  '☀️',  // أنظمة الطاقة الشمسية
  'fire-alarm':   '🚨',  // إنذار وأنظمة حريق
  desktop:        '🖥️',  // إلكترونيات وأجهزة
  laptop:         '💻',  // صيانة حاسوب وطابعات
  // الصحة والعناية
  massage:        '💆',  // حجامة ومساج
  ...
  party:          '🎉',  // تنسيق وتزيين مناسبات
  // تعليم وتدريب
  'book-open':    '📚',  // تدريس خصوصي
  moon:           '🌙',  // تعليم قرآن وتجويد
  // تصميم وأعمال حرة
  'pen-tool':     '✏️',  // تصميم جرافيك
  'code-bracket': '🌐',  // تصميم مواقع وتطبيقات
  'chart-up':     '📈',  // تسويق رقمي وسوشيال ميديا
  document:       '📝',  // كتابة وترجمة
  calculator:     '🧾',  // محاسبة وأعمال مالية
  // الحِرَف اليدوية والتقليدية
  thread:         '🧵',  // خياطة وتفصيل
  stitch:         '🪡',  // تطريز وأعمال يدوية
  shoe:           '👞',  // صناعة وإصلاح أحذية
  // الحيوانات الأليفة
  ...
  gauge:          '⛽',  // إطارات وتغيير زيت
  snowflake:      '🧊',  // تكييف السيارات
  shield:         '🛡️',  // هيكل ودهان السيارات
  droplet:        '💧',  // غسيل وتلميع السيارات
};
...
export const CATEGORY_PLACEHOLDERS: Record<string, { title_ar: string; title_en: string; desc_ar: string; desc_en: string }> = {
  ...
  gardening:           { title_ar: 'مثال: تنسيق حديقة منزلية وزراعة نباتات',    title_en: 'e.g. Home garden landscaping and planting',          desc_ar: 'حدد مساحة الحديقة والخدمات المطلوبة (تصميم، زراعة، تقليم، ري)', desc_en: 'Specify garden area and required services (design, planting, trimming, irrigation)' },
...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  { tier: 'trial',   name_ar: 'تجريبية', name_en: 'Trial',   price_jod: 0,  subscription_credits: 10, max_concurrent_bids: -1, is_unlimited: false, is_trial: true  },
  { tier: 'basic',   name_ar: 'أساسية',  name_en: 'Basic',   price_jod: 5,  subscription_credits: 20, max_concurrent_bids: -1, is_unlimited: false, is_trial: false },
  { tier: 'pro',     name_ar: 'محترف',   name_en: 'Pro',     price_jod: 12, subscription_credits: 50, max_concurrent_bids: -1, is_unlimited: false, is_trial: false },
...
export const JORDAN_CITIES = [
  ...
  'المفرق', 'جرش', 'عجلون', 'الكرك', 'معان', 'الطفيلة', 'مأدبا',
];
